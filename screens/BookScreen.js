  ...
  return (
    ...
    >
      ...
      <View className="px-4">
        ...
        <View className="bg-input rounded-lg shadow-lg p-4 mb-4 flex flex-row flex-wrap justify-between">
        <View className="w-full md:w-1/2 lg:w-1/3 mb-4">
          ...
          <Text className="text-lg text-gray-600 text-center mb-2">
           Idioma: <Text className='uppercase'>{book.volumeInfo.language || 'Desconocido'}</Text>
          </Text>
